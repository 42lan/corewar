...
/*   Updated: 2020/06/18 10:30:32 by amalsago         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** This instruction adds the contents of the 2 first and stores the result
** in the third
*/
...
void		cw_vm_add(t_cw_vm *vm)
{
	...
	vm->game.procs->pos = (vm->game.procs->pos + 2
			+ cw_vm_add_pos(&vm->inst, 3, CW_DIR_SIZE_ADD)) % CW_MEM_SIZE;
}
